...
var Ed25519Keypair = class _Ed25519Keypair extends Keypair {
  ...
  export() {
    return {
      schema: "ED25519",
      privateKey: toB644(this.keypair.secretKey.slice(0, PRIVATE_KEY_SIZE))
    };
  }
};
...
import { fromB58 as fromB582, toB64 as toB647, toHEX as toHEX2 } from "@mysten/bcs";
...
var JsonRpcProvider = class {
  ...
  async executeTransactionBlock(input) {
    return await this.client.requestWithType(
      ...
      [
        typeof input.transactionBlock === "string" ? input.transactionBlock : toB647(input.transactionBlock),
  ...
  async devInspectTransactionBlock(input) {
    ...
    if (isTransactionBlock(input.transactionBlock)) {
      ...
      devInspectTxBytes = toB647(input.transactionBlock);
    } else {
...
var SignerWithProvider = class {
  ...
  async signMessage(input) {
    ...
    return {
      messageBytes: toB648(input.message),
      signature
    };
  }
  ...
  async signTransactionBlock(input) {
    ...
    return {
      transactionBlockBytes: toB648(transactionBlockBytes),
      signature
    };
  }
  /**
