...
var Ed25519Keypair = class _Ed25519Keypair extends Keypair {
  ...
  export() {
    return {
      schema: "ED25519",
      privateKey: (0, import_bcs18.toB64)(this.keypair.secretKey.slice(0, PRIVATE_KEY_SIZE))
    };
  }
};
...
var Secp256k1Keypair = class _Secp256k1Keypair extends Keypair {
  ...
  export() {
    return {
      schema: "Secp256k1",
      privateKey: (0, import_bcs19.toB64)(this.keypair.secretKey)
    };
  }
};
...
function toParsedSignaturePubkeyPair(serializedSignature) {
  const bytes = (0, import_bcs20.fromB64)(serializedSignature);
  const signatureScheme = SIGNATURE_FLAG_TO_SCHEME[bytes[0]];
  if (signatureScheme === "MultiSig") {
    try {
...
function fromExportedKeypair(keypair) {
  const secretKey = (0, import_bcs20.fromB64)(keypair.privateKey);
...
var Secp256r1Keypair = class _Secp256r1Keypair extends Keypair {
  ...
  export() {
    return {
      schema: "Secp256r1",
      privateKey: (0, import_bcs21.toB64)(this.keypair.secretKey)
    };
  }
};
...
var import_bcs26 = require("@mysten/bcs");
...
var TransferObjectsTransaction = (0, import_superstruct15.object)({
  ...
  address: PureTransactionArgument(import_bcs22.BCS.ADDRESS)
});
    ...
    return create(
      {
        kind: "Publish",
        modules: modules.map(
          (module2) => typeof module2 === "string" ? Array.from((0, import_bcs22.fromB64)(module2)) : module2
        ),
...
var TransactionBlockDataBuilder = class _TransactionBlockDataBuilder {
  ...
  static getDigestFromBytes(bytes) {
    ...
    return (0, import_bcs24.toB58)(hash);
  }
  build({
...
var _TransactionBlock = class _TransactionBlock {
  ...
  static fromKind(serialized) {
    ...
    __privateSet(tx, _blockData, TransactionBlockDataBuilder.fromKindBytes(
      typeof serialized === "string" ? (0, import_bcs26.fromB64)(serialized) : serialized
    ));
    return tx;
  }
  /**
...
var JsonRpcProvider = class {
  ...
  async executeTransactionBlock(input) {
    return await this.client.requestWithType(
      ...
      [
        typeof input.transactionBlock === "string" ? input.transactionBlock : (0, import_bcs27.toB64)(input.transactionBlock),
  ...
  async devInspectTransactionBlock(input) {
    ...
    if (isTransactionBlock(input.transactionBlock)) {
      ...
      devInspectTxBytes = (0, import_bcs27.toB64)(
      ...
      devInspectTxBytes = (0, import_bcs27.toB64)(input.transactionBlock);
    } else {
  ...
  async getChainIdentifier() {
    ...
    const bytes = (0, import_bcs27.fromB58)(checkpoint.digest);
    return (0, import_bcs27.toHEX)(bytes.slice(0, 4));
  }
...
var SignerWithProvider = class {
  ...
  async signMessage(input) {
    ...
    return {
      messageBytes: (0, import_bcs28.toB64)(input.message),
      signature
    };
  }
  ...
  async signTransactionBlock(input) {
    ...
    return {
      transactionBlockBytes: (0, import_bcs28.toB64)(transactionBlockBytes),
      signature
    };
  }
  /**
  ...
  async dryRunTransactionBlock(input) {
    ...
    if (isTransactionBlock(input.transactionBlock)) {
      ...
      dryRunTxBytes = (0, import_bcs28.fromB64)(input.transactionBlock);
    } else if (input.transactionBlock instanceof Uint8Array) {
...
async function verifyMessage(message, serializedSignature, scope) {
  ...
  if (scope === 3 /* PersonalMessage */) {
    const messageBytes2 = messageWithIntent(
      scope,
      bcs.ser(["vector", "u8"], typeof message === "string" ? (0, import_bcs30.fromB64)(message) : message).toBytes()
    );
    ...
    const unwrappedMessageBytes = messageWithIntent(
      scope,
      typeof message === "string" ? (0, import_bcs30.fromB64)(message) : message
    );
...
// src/index.ts
var import_bcs32 = require("@mysten/bcs");
